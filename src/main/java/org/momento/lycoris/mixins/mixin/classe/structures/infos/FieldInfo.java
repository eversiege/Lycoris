...
public class FieldInfo implements SizedByteCodec {
    ...
    public FieldInfo(final AccessFlag flags, final char nameIndex, final char descriptorIndex, final AttributeInfo[] attributes) {
        this.flags = flags;
    ...
    public static FieldInfo decode(final ConstantPool[] constantPool, ByteBuffer buffer) {
        ...
        return new FieldInfo(flag, nameIndex, descriptorIndex, attributes);
    }
